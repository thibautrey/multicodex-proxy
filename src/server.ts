...
const providerAgent = startEmbeddedProviderAgent({
  ...
  ...(PROVIDER_AGENT_MANAGED_ROOT && PROVIDER_AGENT_BUNDLED_OLLAMA_ROOT &&
    PROVIDER_AGENT_DEPENDENCY_MANIFEST_PATH && PROVIDER_AGENT_MANAGED_PLANNER_STATE_PATH &&
    PROVIDER_AGENT_MODEL_CATALOG_PATH && PROVIDER_AGENT_DEMAND_TRUSTED_KEYS ? {
