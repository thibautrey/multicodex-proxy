...
```bash
HEALTH_URL=http://192.168.1.149:1455/health ./scripts/deploy.sh
```
...
node scripts/install-codex-project-hook.mjs --url http://192.168.1.149:1455
